...
Methane emissions from freshwater ponds in flooded land remaining flooded land increased by approximately 1 percent from 1990 to 2022. Methane emissions from canals and ditches have remained constant throughout the time series because age data are not available for canals and ditches, thus they are assumed to be greater than 20-years old in 1990 and are included in flooded land remaining flooded land throughout the time series. Overall, CH4 emissions from other constructed waterbodies have remained fairly constant since 1990 (Table 6-87 and Table 6-88).
...
ef %>%
  ...
  select(`Other Constructed Waterbody`, )
  gt() %>%
  tab_header(title = md(
    "Table 6-83: IPCC (2019) Default CH<sub>4</sub> Emission Factors for Surface Emission from Reservoirs in Flooded Land Remaining Flooded Land")) %>%
  cols_label(
