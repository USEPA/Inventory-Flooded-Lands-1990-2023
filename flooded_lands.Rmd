...
library(tidyverse)
library(sf)
#library(USAboundaries) # state map, not available for 4.4
...
#st_layers("~/shared/jbeaulie/inputData/2023_Flooded_Lands_Final_102323.gdb")
st_layers("inputData/2023_Flooded_Lands_Final_102323.gdb")
...
# nwi <- sf::st_read("~/shared/jbeaulie/inputData/2023_Flooded_Lands_Final_102323.gdb",
#                    layer = "NWI_Final_2023",
#                    fid_column_name = "OBJECTID") %>%
nwi <- sf::st_read("inputData/2023_Flooded_Lands_Final_102323.gdb",
                   layer = "NWI_Final_2023",
                   fid_column_name = "OBJECTID") %>%
  janitor::clean_names() %>%
  ...
  rename(area_meters = intersect_area_meters,
         ...
         climate = fldd_zn) %>%
  slice_sample(prop = 0.1) # sample random 10% for development
...
# NAVIGABLE WATERWAYS-------------------------------
# nav <- sf::st_read("~/shared/jbeaulie/inputData/2023_Flooded_Lands_Final_102323.gdb", 
#                    layer = "Navigable_Waterways_2023") %>%
nav <- sf::st_read("inputData/2023_Flooded_Lands_Final_102323.gdb", 
                   layer = "Navigable_Waterways_2023") %>%
  janitor::clean_names() %>%
...
# CANALS AND DITCHES
# canals <- sf::st_read("~/shared/jbeaulie/inputData/2023_Flooded_Lands_Final_102323.gdb", 
#                       layer = "Ditches_Final_2023") %>%
canals <- sf::st_read("inputData/2023_Flooded_Lands_Final_102323.gdb", 
                      layer = "Ditches_Final_2023") %>%
  janitor::clean_names() %>%
...
# nhd <- sf::st_read("~/shared/jbeaulie/inputData/2023_Flooded_Lands_Final_102323.gdb",
#                    layer = "NHD_Final_2023") %>%
nhd <- sf::st_read("inputData/2023_Flooded_Lands_Final_102323.gdb",
                   layer = "NHD_Final_2023") %>%
  janitor::clean_names() %>%
  st_sf() %>% # rename doesn't work after clean_names, st_sf fixes whatever janitor broke
  rename(area_meters = intersect_area_meters,
...
format(utils::object.size(fl.sf), units = "GB") #8.1 GB, 10% subsample of NWI gets down to 1.6GB
...
toc()
format(object.size(fl), units = "auto") #277.9 GB as sf objects (outdated, actually bigger), 34.9 GB as dataframe!
