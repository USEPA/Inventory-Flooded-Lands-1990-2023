...
val.legend <-  seq(0, round(max(us.plot.flrfl.ch4.2023.ocwb.state.gt$ktonnes_ch4_canals_and_ditches), -1), by = 25)
pal.legend <- scales::rescale(val.legend)
...
Canals and ditches, a subset of other constructed waterbodies, were identified in the NWI by their attribute codes. The following NWI attribute codes were interpretted as canals.ditches: R5UBFx, R2UBFx, R2UBHx, R4SBCx, PEM1Cx
